...
An updated Fabric build of **StepUp** for Minecraft 1.19.x.

Current release: `1.4.1+mc1.19`.
...
- Minecraft Java Edition `1.19`, `1.19.1`, `1.19.2`, `1.19.3`, `1.19.4`
- Fabric Loader
- Fabric API
- Java 17 or newer
...
This fork targets the full Minecraft 1.19.x line.
