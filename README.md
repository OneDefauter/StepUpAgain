...
An updated Fabric build of **StepUp** for Minecraft 1.16.x.

Current release: `1.4.1+mc1.16`.
...
- Minecraft Java Edition `1.16`, `1.16.1`, `1.16.2`, `1.16.3`, `1.16.4`, `1.16.5`
- Fabric Loader
- Fabric API
- Java 8 or newer
...
This fork targets the full Minecraft 1.16.x line.
