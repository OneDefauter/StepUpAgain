...
An updated Fabric build of **StepUp** for Minecraft 1.18.x.

Current release: `1.4.1+mc1.18`.
...
- Minecraft Java Edition `1.18`, `1.18.1`, `1.18.2`
- Fabric Loader
- Fabric API
- Java 17 or newer
...
This fork targets the full Minecraft 1.18.x line.
