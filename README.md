...
An updated Fabric build of **StepUp** for Minecraft `1.20` through `1.20.6`.

Current release: `1.4.1+mc1.20`.
...
- Minecraft Java Edition `1.20`, `1.20.1`, `1.20.2`, `1.20.3`, `1.20.4`, `1.20.5`, or `1.20.6`
- Fabric Loader
- Fabric API
- Java 17 or newer

For best accuracy by game version:

- Minecraft `1.20` through `1.20.4` can run on Java 17.
- Minecraft `1.20.5` and `1.20.6` require Java 21 because the game itself requires it.
...
This fork targets the full Minecraft `1.20.x` line.
...
This variant is based on the current Fabric `1.21` line and adapted for the `1.20.x` client APIs and dependency set.
...
This fork exists only to keep the mod usable on newer Fabric versions, including this `1.20.x` build.
