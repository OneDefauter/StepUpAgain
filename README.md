...
An updated Fabric build of **StepUp** for Minecraft 1.17.x.

Current release: `1.4.1+mc1.17`.
...
- Minecraft Java Edition `1.17`, `1.17.1`
- Fabric Loader
- Fabric API
- Java 16 or newer
...
This fork targets the full Minecraft 1.17.x line.
